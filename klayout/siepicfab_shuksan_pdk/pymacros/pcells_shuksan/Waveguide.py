...
class Waveguide(pya.PCellDeclarationHelper):
  ...
  def __init__(self):
    ...
    self.param("CML", self.TypeString, "Compact Model Library (CML)", default = 'SiEPICfab_Shuksan_PDK')
    self.param("model", self.TypeString, "CML Model name", default = 'waveguide_1310') 
